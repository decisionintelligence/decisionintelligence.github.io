    ...
    <div class="tw-h-2/3 md:tw-absolute tw-w-full ">
      ...
      <div v-else class="md:tw-m-auto tw-pt-6 tw-h-full" >
        <div class="tw-grid  tw-h-full tw-grid-cols-1 md:tw-grid-cols-3 md: tw-gap-y-5 tw-gap-x-10">
         ...
         tw-animate-pulse
         tw-text-center tw-flex-col tw-flex  tw-justify-center  tw-rounded-2xl "
               v-for="(item,idx) in 9" :key="idx+4567"
               :id="idx">
            <div class="tw-bg-slate-200 tw-m-auto tw-w-1/3 tw-h-3.5 tw-rounded tw-rounded-2xl"></div>
            <div class="tw-bg-slate-200 tw-mt-3 tw-m-auto tw-w-1/2 tw-h-3.5 tw-rounded tw-rounded-2xl"></div>
          </div>
        </div>
      </div>
    </div>
