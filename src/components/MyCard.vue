<template>
  <div class="tw-h-full card">
    ...
    >
      <img
        :src="require('../assets/img/' + picUrl)"
        style="width: 150px; height: 200px"
        class="tw-float-left tw-mr-4 tw-object-contain tw-mt-2"
      />
      <div
        class="row tw-mt-2 tw-mb-2 tw-text-xl tw-font-bold tw-tracking-tight tw-text-gray-900"
      >
        {{ name }}
      </div>
    ...
    <div
      v-else-if="mode === 'vertical'"
      class="tw-bg-white tw-m-auto tw-h-full tw-border tw-border-gray-200 tw-text-center"
      style="max-width: 230px"
    >
      <img
        style="width: 160px; height: 160px"
        v-if="type !== 'alumni'"
        class="tw-object-contain tw-rounded-l-lg tw-m-auto tw-pt-1"
        :src="require('../assets/img/' + picUrl)"
      />
      <div>
        <div class="tw-mt-1">
